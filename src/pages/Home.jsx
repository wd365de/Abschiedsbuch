...
export default function Home() {
  ...
  return (
    <div className="h-dvh flex flex-col bg-brand overflow-hidden relative">
      ...
      <div className="hidden lg:block absolute z-10 left-[6%] xl:left-[9%] top-1/2 -translate-y-1/2 rotate-[-4deg] w-[240px] xl:w-[300px] animate-fade-in" style={{ animationDelay: '0.5s' }}>
        <div className="relative bg-cream p-2.5 pb-6 shadow-[0_18px_50px_rgba(0,0,0,0.5),0_4px_14px_rgba(0,0,0,0.3)]">
          <div className="absolute -top-3 left-[90px] xl:left-[112px] w-14 h-5 -rotate-[5deg] shadow-[0_1px_4px_rgba(0,0,0,0.25)]" style={{ background: 'rgba(61,186,156,0.55)' }} />
